...
* :doc:`libraries`: under this category you will find from single IP cores to libraries of them, sometimes involving package managers.
* :doc:`managers`: a wrapper allows to avoid/hide complexities, for example in a program invocation, offering an easiest way to perform the same.
