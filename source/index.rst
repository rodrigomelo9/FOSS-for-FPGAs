Getting started with FOSS for digital hardware design
=====================================================
...
* :doc:`asic-tools/index`: here you will found tools specially tailored to work with ASICs, such as a Process Design Kit (PDK).
